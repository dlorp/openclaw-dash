"""Tests for hermes CLI parser."""

from hermes_dash.collectors.hermes_cli import (
    parse_heartbeat,
    parse_latency,
    parse_session_count,
    parse_status_output,
...
SAMPLE_STATUS_OUTPUT = """Hermes Agent status
...
Update available (npm 2026.1.30). Run: hermes update
"""
