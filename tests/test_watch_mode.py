...
class TestDashboardAppRefreshInterval:
    ...
    def test_default_refresh_interval_on_init(self):
        """Test that default refresh interval is 30 seconds when None passed."""
        app = DashboardApp()
    ...
    def test_none_uses_default(self):
        """Test that None uses default refresh interval."""
        app = DashboardApp(refresh_interval=None)
        assert app.refresh_interval == DashboardApp.DEFAULT_REFRESH_INTERVAL
