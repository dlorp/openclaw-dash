...
from hermes_dash.collectors.cache import cached_collector
from hermes_dash.collectors.hermes_cli import get_hermes_status, status_to_sessions_data
from hermes_dash.demo import is_demo_mode, mock_sessions
...
def _collect_sessions_impl() -> dict[str, Any]:
    ...
    for attempt in range(max_attempts):
        try:
            status = get_hermes_status(timeout=8)
