...
Manages user configuration stored in ~/.config/hermes-dash/config.toml with:
...
DEFAULT_CONFIG_DIR = Path.home() / ".config" / "hermes-dash"
...
class SettingsManager:
    ...
    def __init__(self, config_path: Path | None = None) -> None:
        ...
        Args:
            config_path: Path to config file. Defaults to ~/.config/hermes-dash/config.toml
        """
