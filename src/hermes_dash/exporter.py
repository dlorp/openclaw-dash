...
def collect_all_data() -> dict[str, Any]:
    ...
    from hermes_dash.collectors import activity, alerts, channels, cron, gateway, repos, sessions
...
def export_markdown(data: dict[str, Any]) -> str:
    ...
    lines.append("---")
    lines.append("*Exported by hermes-dash*")
...
def export_to_file(
    ...
    if output_path is None:
        ...
        output_path = Path(f"hermes-export-{timestamp}{ext}")
    else:
