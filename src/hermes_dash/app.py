...
from hermes_dash.config import Config, is_bare_mode, load_config
from hermes_dash.screens import SettingsScreen
from hermes_dash.themes import THEMES, next_theme
from hermes_dash.version import get_version_info
...
from hermes_dash.widgets.connection_warning import ConnectionWarningBanner
from hermes_dash.widgets.help_panel import HelpScreen
from hermes_dash.widgets.input_pane import CommandSent, InputPane
from hermes_dash.widgets.logs import LogsPanel
from hermes_dash.widgets.metric_boxes import MetricBoxesBar
from hermes_dash.widgets.metrics import MetricsPanel
from hermes_dash.widgets.notifications import (
    notify_panel_error,
    notify_refresh,
)
from hermes_dash.widgets.resources import ResourcesPanel
from hermes_dash.widgets.security import SecurityPanel
from hermes_dash.widgets.tabbed_groups import (  # noqa: F401 - exported for external use
    CodeTabGroup,
    RuntimeTabGroup,
)
from hermes_dash.widgets.vault import VaultPanel
...
class DashboardApp(App):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(id="vault-panel", classes="panel"):
            with Collapsible(
                title=" Knowledge Vault",
                collapsed=False,
                collapsed_symbol="\u25b8",
                expanded_symbol="\u25be",
                id="vault-panel-collapsible",
            ):
                yield VaultPanel()
    ...
    def on_mount(self) -> None:
        ...
        if not is_bare_mode():
            from hermes_dash.sinks.manager import SinkManager
