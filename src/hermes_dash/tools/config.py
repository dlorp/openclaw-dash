"""
config.py — Shared configuration loading for hermes-dash tools.

Loads configuration from ~/.config/hermes-dash/tools.yaml (or XDG_CONFIG_HOME).
...
Config file example (~/.config/hermes-dash/tools.yaml):
...
def _get_config_path() -> Path:
    ...
    return base / "hermes-dash" / "tools.yaml"
